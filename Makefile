...
CXXFLAGS      = -pipe -msse -msse2 -msse3 -march=native -g -std=c++11 -std=c++11 -Wall -W -Wno-unused-parameter -D_REENTRANT -fPIC $(DEFINES)
...
LIBS          = $(SUBLIBS) -L/usr/local/lib -L/home/i7624405/NGL/lib -l NGL -ltiff -L/opt/qt/5.5/gcc_64/lib -lQt5Gui -L/usr/lib64 -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = myRT.pro include/Triangle.hpp \
		...
		include/Ray.hpp \
		include/BBox.hpp \
		include/Parser.hpp src/main.cpp \
		src/Triangle.cpp \
		src/TriangleMesh.cpp \
		src/Ray.cpp \
		src/BBox.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/Triangle.hpp include/TriangleMesh.hpp include/Ray.hpp include/BBox.hpp include/Parser.hpp $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/Triangle.cpp src/TriangleMesh.cpp src/Ray.cpp src/BBox.cpp src/Parser.cpp $(DISTDIR)/
...
obj/TriangleMesh.o: src/TriangleMesh.cpp include/TriangleMesh.hpp \
		include/Triangle.hpp \
